    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCategoryAssignments", x => new { x.UserId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_UserCategoryAssignments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserCategoryAssignments_TicketCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "TicketCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    TicketSubCategoryId = table.Column<int>(type: "int", nullable: true),
                    KnowledgeBaseArticleId = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_KnowledgeBaseArticles_KnowledgeBaseArticleId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_TicketSubCategories_TicketSubCategoryId",
                        column: x => x.TicketSubCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Discussions_TicketCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "TicketCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, "Technical Support" },
                    { 2, false, "Network Issues" },
                    { 3, false, "Hardware" },
                    { 4, false, "Software" },
                    { 5, false, "Unknown" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_KnowledgeBaseArticleId",
                table: "Tickets",
                column: "KnowledgeBaseArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TicketSubCategoryId",
                table: "Tickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCategoryAssignments_CategoryId",
                table: "UserCategoryAssignments",
                column: "CategoryId");
        }
