...
public class TicketCategoryController(ITicketCategoryRepository categoryRepository) : Controller
{
    ...
    public async Task<IActionResult> CreateCategory(string name)
    {
          ...
          var result =  await categoryRepository.CreateCategory(name);
    ...
    {
        var result = await categoryRepository.SoftDeleteCategory(id);
    ...
    {
        var result = await categoryRepository.SoftDeleteSubCategoryAsync(subCategoryId);
    ...
    public async Task<IActionResult> AddSubCategory(SubCategoryCreateViewModel viewModel)
    {
          ...
          var  result =await categoryRepository.AddSubCategoryAsync(viewModel);
